...
class ProgramSearchAdapter (val arrayList: ArrayList<BerandaProgramAll>, val context: Context) :
    RecyclerView.Adapter<ProgramSearchAdapter.ViewHolder> (){
...
//            itemView.dayProgramAll.text = model.dayFund
    ...
    override fun onBindViewHolder(holder: ProgramSearchAdapter.ViewHolder, position: Int) {
